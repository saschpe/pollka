...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.show_hash'
        db.add_column('polls_poll', 'show_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Poll.edit_hash'
        db.add_column('polls_poll', 'edit_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Poll.show_hash'
        db.delete_column('polls_poll', 'show_hash')

        # Deleting field 'Poll.edit_hash'
        db.delete_column('polls_poll', 'edit_hash')
    ...
    models = {
        ...
        'polls.poll': {
            ...
            'edit_hash': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_hash': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
